...
import 'package:ielts/screens/daily_games_list_screen.dart';
                    ...
                    (context, index) {
                      ...
                      if (index == games.length - 1) {
                        bottomMargin = 124;
                          ...
                          games[index + 1].level.endsWith('2')) {
                        bottomMargin = 37;
                      }
                                  ...
                                  ButtonSecondary(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) => DailyGamesListScreen(),
                                        ),
                                      );
                                    },
                                    isItPrice: false,
