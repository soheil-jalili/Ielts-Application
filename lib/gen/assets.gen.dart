...
class $AssetsImagesGen {
  ...
  AssetGenImage get leftShape =>
      const AssetGenImage('assets/images/left-shape.png');
  ...
  /// File path: assets/images/star-fill.png
  AssetGenImage get starFill =>
      const AssetGenImage('assets/images/star-fill.png');
  ...
  /// File path: assets/images/tree_of_word.png
  AssetGenImage get treeOfWord =>
      const AssetGenImage('assets/images/tree_of_word.png');
  ...
  /// File path: assets/images/zero.png
  AssetGenImage get zero => const AssetGenImage('assets/images/zero.png');
